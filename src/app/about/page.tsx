  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        {/* Moved from the homepage: the transposition animation, the drawers
            walkthrough and the cabinet definition are the deep explanation,
            and About is where a reader arrives already wanting it. */}
        <TranspositionHero />
        <MappingSection />
